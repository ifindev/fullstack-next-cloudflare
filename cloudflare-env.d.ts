/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv ./cloudflare-env.d.ts` (hash: 02fa52aec260d27357691fd6cd6bff73)
...
declare namespace Cloudflare {
	interface Env {
		...
		terrastoties_dev_bucket: R2Bucket;
		terrastories_dev_db: D1Database;
		ASSETS: Fetcher;
	}
}
...
> {
    constructor(
        label?: string,
        options?: TextDecoderStreamTextDecoderStreamInit,
    );
    get encoding(): string;
    get fatal(): boolean;
    get ignoreBOM(): boolean;
...
declare namespace Rpc {
    ...
    type Serializable<T> =
        ...
        | ReadonlyArray<
              T extends ReadonlyArray<infer U> ? Serializable<U> : never
          >
        | {
